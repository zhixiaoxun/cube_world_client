...
public class Lua_UnityEngine_AI_NavMeshBuilder : LuaObject {
	...
	static public int CollectSources_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(UnityEngine.Bounds),typeof(int),typeof(UnityEngine.AI.NavMeshCollectGeometry),typeof(int),typeof(List<UnityEngine.AI.NavMeshBuildMarkup>),typeof(List<UnityEngine.AI.NavMeshBuildSource>))){
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.Transform),typeof(int),typeof(UnityEngine.AI.NavMeshCollectGeometry),typeof(int),typeof(List<UnityEngine.AI.NavMeshBuildMarkup>),typeof(List<UnityEngine.AI.NavMeshBuildSource>))){
