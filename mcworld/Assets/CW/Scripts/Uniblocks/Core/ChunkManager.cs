...
namespace Uniblocks
{
    ...
    public class ChunkManager : MonoBehaviour
    {
        ...
        public static void RemoveChunkFromUpdateQueue(Chunk chunk)
        {
            if (ChunkUpdateQueue.Contains(chunk) == true)
            {
        ...
        public static bool DestroyChunk(int x, int y, int z)
        {
            GameObject chunkObject = ChunkManager.GetChunk(x, y, z);
            if (chunkObject != null)
            {
