...
namespace Uniblocks
{
    ...
    public class Engine : MonoBehaviour
    {
        ...
        SendCursorEvents, EnableInternetplayer, EnableMultiplayer, MultiplayerTrackPosition, SaveVoxelData, GenerateMeshes;

        public bool lShowBorderFaces, lGenerateColliders, lSendCameraLookEvents,
        lSendCursorEvents, lEnableInternetplayer, lEnableMultiplayer, lMultiplayerTrackPosition, lSaveVoxelData, lGenerateMeshes;
