    ...
    public class BlockEditor : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            if (SelectedBlock != null)
            {
                ...
                //prefab
                selectedVoxel.VCustomPrefab = EditorGUILayout.Toggle("Custom prefab", selectedVoxel.VCustomPrefab);
                selectedVoxel.VPrefab = (GameObject)EditorGUILayout.ObjectField("Prefab", selectedVoxel.VPrefab, typeof(GameObject), false);
                if (selectedVoxel.VCustomPrefab)
                {
                    selectedVoxel.VCustomMesh = false;
                    selectedVoxel.VMesh = null;
                }
                else
                    selectedVoxel.VPrefab = null;
                ...
                if (selectedVoxel.VCustomMesh)
                {
                    selectedVoxel.VCustomPrefab = false;
                    selectedVoxel.VPrefab = null;
                }
                else
                    selectedVoxel.VMesh = null;
                ...
                // texture
                if (selectedVoxel.VCustomPrefab == false)
                {
